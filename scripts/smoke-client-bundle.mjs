...
const serialized = await source.codec?.serialize('warning-disposal-report', new AbortController().signal)
if (serialized !== '@{warning-disposal-report}') throw new Error('unexpected model serialization')
